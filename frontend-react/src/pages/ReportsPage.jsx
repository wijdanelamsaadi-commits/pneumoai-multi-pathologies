...
const reports = [
  { title: "Rapport complet d'analyse", type: "PDF", date: "-", status: "Genere apres analyse" },
  { title: "Synthese qualite image", type: "PDF", date: "-", status: "Genere apres analyse" },
  { title: "Export des probabilites", type: "CSV", date: "-", status: "Genere apres analyse" }
];
